...
export default function SignUpPage() {
  ...
  return (
    <div className="px-3 bg-gray-100 flex flex-col justify-center py-8 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <Image src={Logo} alt="Intellidocs" className="mx-auto h-[10rem] w-auto z-10" />
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md z-10">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-200 rounded-lg">
          <div className="mt-6">
            <Button
              type="button"
